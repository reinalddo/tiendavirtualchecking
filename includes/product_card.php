    ...
    <div class="card h-100 shadow-sm product-card">
        ...
        <div class="card-footer bg-transparent border-top-0">
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                 <a href="producto/<?php echo htmlspecialchars($producto['slug']); ?>" class="btn btn-outline-secondary btn-sm flex-grow-1">Detalles</a>
                <form action="carrito_acciones" method="POST" class="flex-grow-1">
